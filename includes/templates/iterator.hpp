...
/*   Updated: 2023/02/11 11:06:57 by dracken24        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
  /*
   * random_access_iterator passes a pointer to type T (type T is passed by vector).
   * reverse_iterator passes random_access_iterator<pointer> (as passed by vector).
   */
  ...
  /*
   * Gets used when a random_access_iterator is created with a const_pointer (i.e. cbegin() and cend())
  ...
  template <typename Iterator_type, typename Container>
    class random_access_iterator {
      ...
      public:
        random_access_iterator() : current_(Iterator_type()) {}

        random_access_iterator(const Iterator_type& i) : current_(i) {}
        ...
        random_access_iterator operator++(int) { return random_access_iterator(current_++); }
  ...
  template <typename Iter1, typename Iter2, typename Container>
    typename random_access_iterator<Iter1, Container>::difference_type operator-(
        const random_access_iterator<Iter1, Container>& lhs,
  ...
  template <typename Iterator, typename Container>
    random_access_iterator<Iterator, Container> operator+(
        typename random_access_iterator<Iterator, Container>::difference_type lhs,
        const random_access_iterator<Iterator, Container>& rhs) {
      return random_access_iterator<Iterator, Container>(rhs.base() + lhs);
    }

  /*
   * Iterator_type is random_access_iterator<pointer> passed by vector
   */
